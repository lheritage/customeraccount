...
module.exports = {
	...
	// API key
	apikey: 'paWjgQtK5aInc1cQtJgToEHO36XUMWCv',
	...
	session: {
		...
		encryptionKey: 'fPzpiof3Z3nudobpiKbxkA2qzRD8fvaH2LvoX5BYq5w=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: '6XF8B8YfXvsWEhK5DNcxOl8/pxaALPtgryk2Hw48UAAa587pf9RTzne+tJ3bLckChzEz4hFLJcj1V+NJDDGXMQ==',
		secret: '3NZbCFqWBbDWKLnXRd5lbPhxvd2V/sGu', // should be a large unguessable string
	...
	cookieSecret: 'y7YSxDVxJ3N+h681Gh7dNP5ADavYmLUa',
